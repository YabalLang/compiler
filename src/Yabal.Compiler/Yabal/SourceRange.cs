...
public readonly record struct SourceRange(Uri File, int StartLine, int StartColumn, int EndLine, int EndColumn, int Index, int Length) : IComparable<SourceRange>
{
    ...
    public static SourceRange From(ParserRuleContext context, Uri file)
    {
    ...
    public static SourceRange From(IToken token, Uri file)
    {
